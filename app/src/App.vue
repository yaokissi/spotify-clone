      ...
      <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items-center">
          <img
              class="rounded-full"
              width="27"
              src="https://lh3.googleusercontent.com/-3D7T7t7oYx8/AAAAAAAAAAI/AAAAAAAAAAA/ALKGfkklb16uML2c4F6-hh0CvWTdXazOhQ/photo.jpg?sz=46"
          >
          <div class="text-white text-[14px] ml-1.5 font-semibold">Ydev</div>
